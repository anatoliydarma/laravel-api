...
')
     ...
     */ 
        ...
        {
                        /** @var \LaravelAt\ImageSanitize\ImageSanitize $instance */
                        return $instance->detect($content);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \LaravelAt\ImageSanitize\ImageSanitize $instance */
                        return $instance->sanitize($content);
        }
...
namespace  { 
            ...
            class ImageSanitize extends \LaravelAt\ImageSanitize\Facades\ImageSanitizeFacade {}
